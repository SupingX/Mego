...
public abstract class AbstractProtolNotify {
	 ...
	 * @return
	 */
	public abstract int parseStepStatus(byte[] data);
	 ...
	 * </p>
	 * */
	public abstract StepInfo parseStep(byte[] data);
	 ...
	 * @return
	 */
	public abstract int parsePathStatus(byte[] data);
	 ...
	 * </p>
	 * <p>
	 * XXXXXX Lng：3 bytes经度 （第一个字节的最高位是符号位，0正1负） ｛0x01，0x02，0x03｝>> 0x010203 >>
	 ...
	 * </p>
	 * */
	public abstract PathInfo parsePath(byte[] data);
	 ...
	 * @return
	 */
	public abstract int parseSleepStatus(byte[] data);
	 ...
	 * @return
	 */
	public abstract SleepInfo parseSleep(byte[] data);
