...
//	public abstract byte[] getByteForTimeSync(long dateTime);
	 ...
	 * </p>
	 **/
	public abstract byte[] getByteForWatchSetting(int unit, int height, int weight, int year,int month,int day, int sex, int stepOnoff,int walkLength, int runLength, int hrOnoff, int hrMax, int hrMin, int sleepOnoff, int sleepHour,
	...
	public abstract byte[] getByteForSportPlanSetting(int sportPlanOnoff, int startHour, int startMin, int sportGoal, int sportGoalDistance, int autoSignOnoff, int signDistance, int paceOnoff,
			int paceMin, int paceMax,  int sportStyle,int goalOnoff);
	 ...
	 * </p>
	 **/
	public abstract byte[] getByteForRemindSetting(int incomingOnoff, int alarmOnoff, int alarmHour, int alarmMin, int longSitOnoff, int longsitValue, int birthdayOnoff,
	 ...
	 * @return
	 */
	public abstract byte[] getByteForRequstWatchConfigration(int type);
	 ...
	 * 
	 * @param type
	 *            0x00——请求当前的计步数据 0x01——请求当前的轨迹数据 (删除)
	 *            
	 *            0x03--当前运动信息
	 * @return
	 */
	public abstract byte[] getByteForRequstCurrentSportInfo();
	...
	public abstract byte[] getByteForRequestHistorySportInfo();
...
//	public abstract byte[] getByteForRequestHistoryPath(int type,long time );
	 ...
	 * @return
	 */
	public abstract byte[] getByteForRequestHistorySleep();
...
即从2000年1月1日0时0分0秒起已经过了315360000秒，即10*365*24*3600；
	 ...
	 * @return
	 */
	public abstract byte[] getByteForRequestDelete(int type,int sbType,long startDate, long endDate);
