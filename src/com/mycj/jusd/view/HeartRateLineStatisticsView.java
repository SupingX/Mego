...
public class HeartRateLineStatisticsView extends LineStatisticsView {
	private float[] datas;
	...
	public HeartRateLineStatisticsView(Context context, AttributeSet attrs,
			int defStyleAttr) {
	...
	public HeartRateLineStatisticsView(Context context) {
		super(context);
	}

	@Override
	public String[] getmarkerYs() {
		return new String[] { "60", "70", "80", "90","100", "110", "120", "130","140" };
	}
...
//					paintLine);
	...
	private void drawText(Canvas canvas){
		if (touchPosition !=-1) {
			...
			String info ="心率"+String.valueOf(datas[touchPosition])+"次/分钟";
