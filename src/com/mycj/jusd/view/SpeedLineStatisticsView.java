...
public class SpeedLineStatisticsView extends LineStatisticsView {
	private float[] datas;
	...
	public SpeedLineStatisticsView(Context context, AttributeSet attrs,
			int defStyleAttr) {
	...
	public SpeedLineStatisticsView(Context context) {
		super(context);
	}
...
//					paintLine);
	...
	private void drawText(Canvas canvas){
		if (touchPosition !=-1) {
			...
			String info ="速度"+String.valueOf(datas[touchPosition])+"公里/时";
