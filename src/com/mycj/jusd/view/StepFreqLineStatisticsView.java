...
public class StepFreqLineStatisticsView extends LineStatisticsView {
	private float[] datas;
	...
	public StepFreqLineStatisticsView(Context context, AttributeSet attrs,
			int defStyleAttr) {
	...
	public StepFreqLineStatisticsView(Context context) {
		super(context);
	}
...
//					paintLine);
	...
	private void drawText(Canvas canvas){
		if (touchPosition !=-1) {
			String time = getStepTime(touchPosition);
			String info ="步数"+String.valueOf(datas[touchPosition]);
			String infoDistance ="步长"+String.valueOf(datas[touchPosition] *18) +"M";
